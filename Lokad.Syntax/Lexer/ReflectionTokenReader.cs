...
namespace Lokad.Syntax.Lexer
{
    ...
    {
        public ReflectionTokenReader() : base(StaticRules, StaticError, StaticEnd, StaticIndent, StaticDedent, StaticEndOfLine, StaticEscapeNewlines, StaticComments)
        {
        }
            ...
            HashSet<TTok> seen)
        {
            ...
            return parents
                ...
                .Select(kv => new LexerRule<TTok>(
                    ...
                    SubRules(kv.Key, defs, parents, publicChildren, seen)))
                .ToArray();
        } 
